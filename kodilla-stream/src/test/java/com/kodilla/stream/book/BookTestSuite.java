...
public class BookTestSuite {
    ...
    @Test
    public void testGetListUsingIntStreamInt() {
        //Given
        BookDirectory bookDirectory = new BookDirectory();
        //When
        List<Book> books = bookDirectory.getList();
    ...
    @Test
    public void testGetUsingIntStreamLong() {
        //Given
        BookDirectory bookDirectory = new BookDirectory();
        //When
        List<Book> books = bookDirectory.getList();
        ...
        long numberOfBooksPublicatedAfter2007 = IntStream.range(0, books.size())
                .filter(n -> books.get(n).getYearOfPublication() > 2000)
                .count();
        assertEquals(5, numberOfBooksPublicatedAfter2007);
    }
}
